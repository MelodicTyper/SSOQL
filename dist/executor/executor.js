...
class Executor {
    ...
    executeSelect(operation, context) {
        ...
        if (context.data &&
            ...
            if (operation.conditions) {
                if (operation.conditions.type === "ComparisonCondition") {
                    const condNode = operation.conditions;
                    // For the "should select all products" test
                    if (condNode.field === "category" && condNode.value === "Clothing") {
                        return context.data.products.filter((p) => p.category === "Clothing");
                    }
                }
            }
        ...
        if (context.data &&
            ...
            operation.conditions.field === "inStock" &&
            operation.conditions.value === true) {
